...
public class MLCanvas : MonoBehaviour
{
    ...
    private MLButton selectedButton = null;
    ...
    private void SelectButton(MLButton button)
    {
        if (button != selectedButton)
        {
            ...
            if (selectedButton != null)
            {
                ...
                controller.Vibrate(MLInputControllerFeedbackPatternVibe.Click);
            }
        }
    }
    ...
    private void OnControllerTouchpadGestureStart(byte controllerId, MLInputControllerTouchpadGesture touchpadGesture)
    {
        if (interactionEnabled)
        {
    ...
    private void OnControllerTouchpadGestureContinue(byte controllerId, MLInputControllerTouchpadGesture touchpadGesture)
    {
        if (interactionEnabled)
        {
            OnControllerTouchpadGesture(touchpadGesture);
    ...
    private void OnControllerTouchpadGesture(MLInputControllerTouchpadGesture touchpadGesture)
    {
