...
public class ParentedViveTrackers{
    ...
    Vector3 _pegboardOffsetIn,int mostRecentCamToHaveSeenDonutIn){
...
public class ViveTrackerPlacer : MonoBehaviour
{
    ...
    void positionTrackers(ParentedViveTrackers trackers){
        ...
        if (mainMarker.found){
            ...
            _viveRightHand.gameObject.transform.localPosition=trackers.rightControllerOffset+trackers._manipulatorOffset;
            ...
            for (int camIndex=0;camIndex<endoscopeObjectCorrespondences.Length;camIndex++){
                ...
                if (camIndex==trackers.mostRecentCamToHaveSeenDonut){
                    ...
                    endoscopeObjectCorrespondences[camIndex].baseMarkerVisuals.material.color=donutColorsWhenVisible[camIndex];
                    ...
                    endoscopeObjectCorrespondences[camIndex].donutTrackingCamVisuals.material.color=donutColorsWhenNotVisible[camIndex];
